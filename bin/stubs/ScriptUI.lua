...
setmetatable(ScriptUI, {__call = function(self) return ScriptUI end})
...
---@type fun(text:string, function:string)
ScriptUI.addDialogOption = function ()
	return nil
end

---@type fun(rect:Rect)
ScriptUI.createWindow = function ()
	return nil
end
...
-- @return nothing
---@type fun(dialog:Dialog, closeable:any)
ScriptUI.interactShowDialog = function ()
	return nil
end

-- @return nothing
---@type fun(caption:string, function:string)
ScriptUI.registerInteraction = function ()
	return nil
end

-- @return nothing
---@type fun(window:Window, caption:string)
ScriptUI.registerWindow = function ()
	return nil
end
...
-- @return nothing
---@type fun(acceptCallback:string, rejectCallback:string)
ScriptUI.startHailing = function ()
	return nil
end
