...
function EntityDescriptor()
	...
	EntityDescriptor.aiOwned = true -- [read-only] bool
	EntityDescriptor.allianceOwned = true -- [read-only] bool
	EntityDescriptor.canPassRifts = true -- [read-only] bool
	EntityDescriptor.controlActions = 0 -- int
	EntityDescriptor.crew = Crew() -- Crew
	EntityDescriptor.crewSize = nil -- [read-only] var
	EntityDescriptor.damageMultiplier = 0.0 -- float
	EntityDescriptor.desiredVelocity = 0.0 -- float
	EntityDescriptor.durability = 0.0 -- double
	EntityDescriptor.excludedPlayer = 0 -- int
	EntityDescriptor.exclusionTime = 0 -- int
	EntityDescriptor.factionIndex = 0 -- int
	EntityDescriptor.fighterCargoPickup = true -- [read-only] bool
	EntityDescriptor.firePower = 0.0 -- [read-only] double
	EntityDescriptor.freeCargoSpace = nil -- [read-only] var
	EntityDescriptor.hasPilot = true -- [read-only] bool
	EntityDescriptor.hyperspaceCooldown = 0.0 -- float
	EntityDescriptor.hyperspaceJumpReach = 0.0 -- float
	EntityDescriptor.id = 0 -- [read-only] Uuid
	EntityDescriptor.index = 0 -- [read-only] Uuid
	EntityDescriptor.invincible = true -- bool
	EntityDescriptor.isAnomaly = true -- [read-only] bool
	EntityDescriptor.isArmedTurret = nil -- [read-only] var
	EntityDescriptor.isAsteroid = true -- [read-only] bool
	EntityDescriptor.isDrone = true -- [read-only] bool
	EntityDescriptor.isFighter = true -- [read-only] bool
	EntityDescriptor.isFlyable = true -- [read-only] bool
	EntityDescriptor.isLoot = true -- [read-only] bool
	EntityDescriptor.isObviouslyMineable = true -- bool
	EntityDescriptor.isOther = true -- [read-only] bool
	EntityDescriptor.isShieldActive = nil -- [read-only] var
	EntityDescriptor.isShip = true -- [read-only] bool
	EntityDescriptor.isStation = true -- [read-only] bool
	EntityDescriptor.isTurning = nil -- [read-only] var
	EntityDescriptor.isTurret = true -- [read-only] bool
	EntityDescriptor.isUnarmedTurret = nil -- [read-only] var
	EntityDescriptor.isUnknown = true -- [read-only] bool
	EntityDescriptor.isWormHole = true -- [read-only] bool
	EntityDescriptor.isWreckage = true -- [read-only] bool
	EntityDescriptor.look = vec3() -- [read-only] vec3
	EntityDescriptor.mass = nil -- [read-only] var
	EntityDescriptor.maxCargoSpace = nil -- [read-only] var
	EntityDescriptor.maxCrewSize = nil -- [read-only] var
	EntityDescriptor.maxDurability = nil -- [read-only] var
	EntityDescriptor.minCrew = Crew() -- [read-only] Crew
	EntityDescriptor.name = "" -- string
	EntityDescriptor.numCargos = nil -- [read-only] var
	EntityDescriptor.numDefenseWeapons = 0 -- [read-only] int
	EntityDescriptor.numDefenseWeaponsCurrentAttack = 0 -- [read-only] int
	EntityDescriptor.numTurrets = nil -- [read-only] var
	EntityDescriptor.occupiedCargoSpace = nil -- [read-only] var
	EntityDescriptor.orientation = Matrix() -- Matrix
	EntityDescriptor.playerOwned = true -- [read-only] bool
	EntityDescriptor.position = Matrix() -- Matrix
	EntityDescriptor.radius = nil -- [read-only] var
	EntityDescriptor.reservationTime = 0.0 -- float
	EntityDescriptor.reservedPlayer = 0 -- int
	EntityDescriptor.right = vec3() -- [read-only] vec3
	EntityDescriptor.selectedObject = nil -- var
	EntityDescriptor.shieldDurability = 0.0 -- double
	EntityDescriptor.shieldMaxDurability = 0.0 -- double
	EntityDescriptor.size = vec3() -- [read-only] vec3
	EntityDescriptor.timeAlive = nil -- [read-only] var
	EntityDescriptor.title = "" -- string
	EntityDescriptor.translatedTitle = nil -- [read-only] var
	EntityDescriptor.translation = dvec3() -- dvec3
	EntityDescriptor.translationf = vec3() -- [read-only] vec3
	EntityDescriptor.transporterRange = 0.0 -- [read-only] double
	EntityDescriptor.type = 0 -- int
	EntityDescriptor.typename = "" -- [read-only] string
	EntityDescriptor.up = vec3() -- [read-only] vec3
	EntityDescriptor.volume = nil -- [read-only] var
