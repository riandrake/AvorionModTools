...
---@type fun(a:number, r:number, g:number, b:number)
ColorARGB = function ()
	return nil
end
...
---@type fun(r:number, g:number, b:number)
ColorRGB = function ()
	return nil
end

---@type fun(turret:Entity)
CreateTemplateFromTurret = function ()
	return nil
end
...
---@type fun(style:PlanStyle, seed:Seed, volume:number, maxBlocks:number, scaleToFit:any, material:Material)
GeneratePlanFromStyle = function ()
	return nil
end
...
---@type fun(i:number)
IsValidMaterial = function ()
	return nil
end

---@type fun(file:string)
LoadPlanFromFile = function ()
	return nil
end

---@type fun(path:string)
LoadTurretDesignFromFile = function ()
	return nil
end
...
---@type fun(look:vec3, up:vec3)
MatrixLookUp = function ()
	return nil
end

---@type fun(look:vec3, up:vec3, pos:vec3)
MatrixLookUpPosition = function ()
	return nil
end

---@type fun(look:vec3, up:vec3, right:vec3)
MatrixLookUpRight = function ()
	return nil
end

---@type fun(yaw:number, pitch:number, roll:number)
MatrixYawPitchRoll = function ()
	return nil
end
...
-- @return nothing
---@type fun(type:string, uuid:Uuid, text:string, icon:string, color:any)
addShipProblem = function ()
	return nil
end
...
-- @return nothing
---@type fun(callbackFunction:string, code:string, arguments:table<number,var>)
async = function ()
	return nil
end
...
-- @return nothing
---@type fun(functionName:string, arguments:table<number,var>)
broadcastInvokeClientFunction = function ()
	return nil
end
...
---@type fun(string)
checkReadSecureFilename = function ()
	return nil
end

---@type fun(string)
checkWriteSecureFilename = function ()
	return nil
end
...
---@type fun(time:number, function:string, args:table<number,var>)
...
-- @return nothing
---@type fun(message:string, sender:string, type:number)
displayChatMessage = function ()
	return nil
end

-- This function is only available on the client.
-- @return nothing
---@type fun(bigText:string, smallText:string)
displayMissionAccomplishedText = function ()
	return nil
end
...
-- @return nothing
---@type fun(entity:Entity, text:string)
displaySpeechBubble = function ()
	return nil
end
...
-- This function is only available on the client.
-- @return nothing
---@type fun(box:Box, matrix:Matrix, color:Color)
...
-- This function is only available on the client.
-- @return nothing
---@type fun(a:vec3, b:vec3, color:Color)
...
-- This function is only available on the client.
-- @return nothing
---@type fun(sphere:Sphere, color:Color)
...
-- This function is only available on the client.
-- @return nothing
---@type fun(fighter:FighterTemplate)
drawFighterTooltip = function ()
	return nil
end
...
-- @return nothing
---@type fun(text:string, px:number, py:number, color:Color, size:number, bold:number, italic:number, style:number)
drawText = function ()
	return nil
end
...
-- @param style - The style of the text, 0 is default style, 1 is shadowed, 2 is outlined
-- @return nothing
---@type fun(text:string, rect:Rect, horizontalAlignment:number, verticalAlignment:number, color:Color, size:number, bold:number, italic:number, style:number)
drawTextRect = function ()
	return nil
end
...
-- @return nothing
---@type fun(args:table<number,var>)
eprint = function ()
	return nil
end
...
-- @param arguments - An arbitrary number of arguments that will be given to the remote function
-- @return nothing
---@type fun(player:Player, functionName:string, arguments:table<number,var>)
invokeClientFunction = function ()
	return nil
end
...
---@type fun(x:number, y:number, printErrors:boolean, entityId:any, scriptName:string, functionName:string, arguments:table<number,var>)
invokeEntityFunction = function ()
	return nil
end
...
-- @param arguments - The arguments that will be passed to the function.
-- @return nothing
---@type fun(x:number, y:number, errorMessage:string, entityId:any, scriptName:string, functionName:string, arguments:table<number,var>)
invokeEntityFunction = function ()
	return nil
end
...
---@type fun(factionIndex:number, printErrors:boolean, scriptName:string, functionName:string, arguments:table<number,var>)
invokeFactionFunction = function ()
	return nil
end
...
-- @param arguments - The arguments that will be passed to the function.
-- @return nothing
---@type fun(x:number, y:number, errorMessage:any, scriptName:string, functionName:string, arguments:table<number,var>)
invokeSectorFunction = function ()
	return nil
end
...
-- @param arguments - The arguments that will be passed to the function
-- @return 1 if the sector wasn't loaded into memory, 0 otherwise.
---@type fun(x:number, y:number, printErrors:boolean, scriptName:string, functionName:string, arguments:table<number,var>)
invokeSectorFunction = function ()
	return nil
end
...
---@type fun(directory:string)
listFilesOfDirectory = function ()
	return nil
end

---@type fun(eye:vec3, at:vec3, up:vec3)
lookAt = function ()
	return nil
end

---@type fun(x:number, y:number, seed:number)
makeFastHash = function ()
	return nil
end

---@type fun(values:table<number,var>)
makeHash = function ()
	return nil
end
...
onGalaxyMapKeyboardEvent = function ()
	return nil
end
...
---@type fun(fov:number, aspect:number, nearClip:number, farClip:number)
...
-- This function is only available on the client.
-- @return nothing
---@type fun(soundName:string, type:number, position:vec3, radius:number, volume:number, entity:nil]:[or:Entity)
play3DSound = function ()
	return nil
end

-- This function is only available on the client.
-- @return nothing
---@type fun(soundName:string, type:number, volume:number)
playSound = function ()
	return nil
end
...
---@type fun(singular:string, plural:string, number:number)
plural_t = function ()
	return nil
end
...
-- @param number - The number that is to be displayed
---@type fun(singular:string, plural:string, context:string, number:number)
plural_with_context_t = function ()
	return nil
end
...
-- This function is only available on the client.
-- @return nothing
---@type fun(entityId:Uuid, healthColor:any, shieldColor:any, track:any, name:any)
registerBoss = function ()
	return nil
end
...
-- This function is only available on the client.
-- @return nothing
---@type fun(type:string, uuid:Uuid)
removeShipProblem = function ()
	return nil
end
...
---@type fun(in:Matrix, angle:number, axis:vec3)
rotate = function ()
	return nil
end
...
---@type fun(script:string, func:string, params:table<number,var>)
run = function ()
	return nil
end
...
-- @param arguments - The arguments that will be passed to the function
-- @return 1 if the sector wasn't loaded into memory, 0 otherwise.
---@type fun(x:number, y:number, printErrors:boolean, entityId:any, code:string, functionName:string, arguments:table<number,var>)
runEntityCode = function ()
	return nil
end
...
-- @param arguments - The arguments that will be passed to the function
-- @return 1 if the player wasn't logged in, 0 otherwise.
---@type fun(factionIndex:number, printErrors:boolean, code:string, functionName:string, arguments:table<number,var>)
runFactionCode = function ()
	return nil
end
...
-- @param arguments - The arguments that will be passed to the function
-- @return 1 if the sector wasn't loaded into memory, 0 otherwise.
---@type fun(x:number, y:number, printErrors:boolean, code:string, functionName:string, arguments:table<number,var>)
runSectorCode = function ()
	return nil
end

---@type fun(in:Matrix, size:vec3)
scale = function ()
	return nil
end
...
-- This function is only available on the client.
-- @return nothing
---@type fun(id:Uuid, health:any, maxHealth:any, shield:any, maxShield:any)
...
-- This function is only available on the client.
-- @return nothing
---@type fun(id:Uuid, health:any, shield:any)
setBossHealthColor = function ()
	return nil
end
...
topLevelGenerate = function ()
	return nil
end

---@type fun(in:Matrix, pos:vec3)
translate = function ()
	return nil
end
...
-- This function is only available on the client.
-- @return nothing
---@type fun(entityId:Uuid)
unregisterBoss = function ()
	return nil
end
