...
function Entity(id)
	...
	Entity.aiOwned = true -- [read-only] bool
	Entity.allianceOwned = true -- [read-only] bool
	Entity.canPassRifts = true -- [read-only] bool
	Entity.controlActions = 0 -- int
	Entity.crew = Crew() -- Crew
	Entity.crewSize = nil -- [read-only] var
	Entity.damageMultiplier = 0.0 -- float
	Entity.desiredVelocity = 0.0 -- float
	Entity.durability = 0.0 -- double
	Entity.excludedPlayer = 0 -- int
	Entity.exclusionTime = 0 -- int
	Entity.factionIndex = 0 -- int
	Entity.fighterCargoPickup = true -- [read-only] bool
	Entity.firePower = 0.0 -- [read-only] double
	Entity.freeCargoSpace = nil -- [read-only] var
	Entity.hasPilot = true -- [read-only] bool
	Entity.hyperspaceCooldown = 0.0 -- float
	Entity.hyperspaceJumpReach = 0.0 -- float
	Entity.id = 0 -- [read-only] Uuid
	Entity.index = 0 -- [read-only] Uuid
	Entity.invincible = true -- bool
	Entity.isAnomaly = true -- [read-only] bool
	Entity.isArmedTurret = nil -- [read-only] var
	Entity.isAsteroid = true -- [read-only] bool
	Entity.isDrone = true -- [read-only] bool
	Entity.isFighter = true -- [read-only] bool
	Entity.isFlyable = true -- [read-only] bool
	Entity.isLoot = true -- [read-only] bool
	Entity.isObviouslyMineable = true -- bool
	Entity.isOther = true -- [read-only] bool
	Entity.isShieldActive = nil -- [read-only] var
	Entity.isShip = true -- [read-only] bool
	Entity.isStation = true -- [read-only] bool
	Entity.isTurning = nil -- [read-only] var
	Entity.isTurret = true -- [read-only] bool
	Entity.isUnarmedTurret = nil -- [read-only] var
	Entity.isUnknown = true -- [read-only] bool
	Entity.isWormHole = true -- [read-only] bool
	Entity.isWreckage = true -- [read-only] bool
	Entity.look = vec3() -- [read-only] vec3
	Entity.mass = nil -- [read-only] var
	Entity.maxCargoSpace = nil -- [read-only] var
	Entity.maxCrewSize = nil -- [read-only] var
	Entity.maxDurability = nil -- [read-only] var
	Entity.minCrew = Crew() -- [read-only] Crew
	Entity.name = "" -- string
	Entity.numCargos = nil -- [read-only] var
	Entity.numDefenseWeapons = 0 -- [read-only] int
	Entity.numDefenseWeaponsCurrentAttack = 0 -- [read-only] int
	Entity.numTurrets = nil -- [read-only] var
	Entity.occupiedCargoSpace = nil -- [read-only] var
	Entity.orientation = Matrix() -- Matrix
	Entity.playerOwned = true -- [read-only] bool
	Entity.position = Matrix() -- Matrix
	Entity.radius = nil -- [read-only] var
	Entity.reservationTime = 0.0 -- float
	Entity.reservedPlayer = 0 -- int
	Entity.right = vec3() -- [read-only] vec3
	Entity.selectedObject = nil -- var
	Entity.shieldDurability = 0.0 -- double
	Entity.shieldMaxDurability = 0.0 -- double
	Entity.size = vec3() -- [read-only] vec3
	Entity.timeAlive = nil -- [read-only] var
	Entity.title = "" -- string
	Entity.translatedTitle = nil -- [read-only] var
	Entity.translation = dvec3() -- dvec3
	Entity.translationf = vec3() -- [read-only] vec3
	Entity.transporterRange = 0.0 -- [read-only] double
	Entity.type = 0 -- int
	Entity.typename = "" -- [read-only] string
	Entity.up = vec3() -- [read-only] vec3
	Entity.volume = nil -- [read-only] var
